...
describe("Calculadora", function () {
  ...
  describe('2. OPERACIONES UNITARIAS', function() {
    ...
    it('a: Comprobando la funcionalidad "absoluto"...', async function () {
        this.score = 0.5;
        this.msg_ok = `Funcionalidad comprobada correctamente`;

        this.msg_err = "No se encuentra el botón con id 'absoluto'";
        browser.assert.element('button#absoluto');
        this.msg_err = "El botón valor absoluto no funciona correctamente";
        [error_nav, resp] = await Utils.to(browser.fill('#pantalla', 2));
        [error_nav, resp] = await Utils.to(browser.click('#absoluto'));
